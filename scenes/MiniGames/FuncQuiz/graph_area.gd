...
var scale_factor: float = 50.0  # пикселей на единицу по x и y
...
func _draw() -> void:
	...
	var grid_color: Color = Color(0.6, 0.6, 0.6, 0.3)
	var axis_color: Color = Color(0.2, 0.2, 0.2, 0.8)
	...
	draw_string(font, Vector2(size.x - 30, center.y - 10), "x", HORIZONTAL_ALIGNMENT_CENTER, -1, font_size, label_color)
